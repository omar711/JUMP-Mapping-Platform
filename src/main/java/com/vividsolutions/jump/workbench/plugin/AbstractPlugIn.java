...
public abstract class AbstractPlugIn implements PlugIn {
	 ...
	 *             appropraite point before each uppercase+lowercase and
		...
		return new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					//topmost layer manager after (e.g. NewTaskPlugIn). [Jon
					// Aquino]
	...
	public static void execute(UndoableCommand command,
		...
		//Used to do nothing if command or panel were null, but that seems to
		// me now
		//like a dangerous thing to do. So I've taken it out, and hopefully
		// will receive
		//a complaint from someone about a NullPointerException. When I find
		// out
		...
		try {
			...
			//Funny logic because I want to avoid adding a throws clause to
			// this method,
