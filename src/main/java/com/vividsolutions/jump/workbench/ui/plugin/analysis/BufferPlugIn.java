    ...
    implements ThreadedPlugIn
{
  ...
  private final static String END_CAP_STYLE = "End Cap Style";

  private final static String CAP_STYLE_ROUND = "Round";
  private final static String CAP_STYLE_SQUARE = "Square";
  private final static String CAP_STYLE_BUTT = "Butt";
  ...
  public void run(TaskMonitor monitor, PlugInContext context)
    ...
    context.addLayer(categoryName, "Buffer-" + layer.getName(), resultFC);
    if (exceptionThrown)
  ...
  private void setDialogValues(MultiInputDialog dialog, PlugInContext context)
  {
    ...
    dialog.setSideBarDescription(
        "Buffers all geometries in the source layer");
