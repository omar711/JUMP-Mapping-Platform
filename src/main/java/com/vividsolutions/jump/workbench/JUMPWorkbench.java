...
public class JUMPWorkbench {
	...
	//public static final String VERSION_TEXT = "1.2-alpha1";
	...
	public JUMPWorkbench(String title, String[] args, ImageIcon icon,
		...
		if (commandLine.hasOption(PROPERTIES_OPTION)) {
			...
			if (propertiesFile.exists()) {
				...
				System.out
						.println("JUMP: Warning: Properties file does not exist: "
								+ propertiesFile);
			}
		}
	...
	public static void main(String[] args) {
		try {
			...
			ProgressMonitor progressMonitor = (ProgressMonitor) progressMonitorClass
					.newInstance();
			SplashPanel splashPanel = new SplashPanel(splashImage(), "Version "
			...
			main(args, "JUMP Workbench", new JUMPConfiguration(), splashPanel,
					progressMonitor);
		} catch (Throwable t) {
